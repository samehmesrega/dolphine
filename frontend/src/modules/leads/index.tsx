...
import RolesPage from '../../shared/pages/RolesPage';
...
import DualNameSettingsPage from './pages/DualNameSettingsPage';
...
export default function LeadsModule() {
  return (
    <Routes>
      ...
      <Route path="dual-name-settings" element={<DualNameSettingsPage />} />
